...
#     @Last modified by: Shivraj Yelave
#     @Last modified time: 22-08-24
#     @Title: Class-based SQL Operations Script using pyodbc
# '''
...
#             print(f"Database '{database_name}' created successfully.")
#         except:
#             print(f"Error creating database: Database already exists.")

#     def create_table(self, database_name, table_name, table_structure):
#         '''
#         Creates a table with the specified name and structure in the specified database.
...
#     def insert_data_in_table(self, table_name, columns, values):
#         '''
#         Inserts the specified values into the specified columns of the given table.
        
#         Parameters:
#             database_name (str): The name of the database containing the table.
#             table_name (str): The name of the table in which data will be inserted.
#             columns (str): The columns into which data will be inserted (comma-separated).
#             values (str): The values to insert (comma-separated).
...
#         Parameters:
#             database_name (str): The name of the database containing the table.
#             table_name (str): The name of the table from which data will be selected.
#             columns (str, optional): The columns to select (comma-separated). Defaults to '*' for all columns.
...
#             table_name (str): The name of the table to update.
#             set_statement (str): The column and new value to set (e.g., "name = 'John'").
#             condition (str): The condition to apply for the update (e.g., "id = 1").
...
#     def delete_entry(self, table_name, condition):
#         '''
#         Deletes an entry from the specified table based on the condition.
        
#         Parameters:
#             database_name (str): The name of the database containing the table.
#             table_name (str): The name of the table from which to delete the entry.
#             condition (str): The condition to apply for the deletion (e.g., "id = 1").
...
#             if  not db.show_columns(table_name):
#                 continue
#             print("Existing  columns:",db.show_columns(table_name))

#             columns = input("Enter columns (comma-separated e.g., id, name): ")
#             values = input("Enter values (comma-separated eg., 1,shiv): ")
#             db.insert_data_in_table( table_name, columns, values)
...
#                 continue
#             print("Existing  columns:",db.show_columns(table_name))
#             set_statement = input("Enter the column and new value (e.g., name = 'John'): ")
#             condition = input("Enter the condition (e.g., id = 1): ")
#             db.update_data( table_name, set_statement, condition)
...
#             rows = db.select_data(db_name, table_name, columns)
